        ...
        child: asyncSettings.when(
          data: (settings) => ListView(
            ...
            SwitchListTile(
              ...
              onChanged: (value) {
                _update(
                    ref, settings.copyWith(weatherAnnouncementsEnabled: value));
              },
            ),
            if (kDebugMode) ...[
              ...
              Card(
                child: ListTile(
                  ...
                  subtitle: const Text('Debug-only: check next upcoming event'),
            ...
            SwitchListTile(
              ...
              onChanged: (value) {
                _update(ref, settings.copyWith(locationProfilesEnabled: value));
              },
            ),
            if (settings.locationProfilesEnabled) ...[
              ...
              Wrap(
                ...
                children: [
                  ...
                  OutlinedButton(
                    onPressed: () => _clearHomeLocation(context, ref, settings),
                    child: const Text('Clear Home'),
                  ),
                  OutlinedButton(
                    onPressed: () => _clearWorkLocation(context, ref, settings),
                    child: const Text('Clear Work'),
                  ),
                  OutlinedButton(
                    onPressed: () => _clearAllLocations(context, ref, settings),
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Use separate voices for time and weather'),
              value: settings.multiVoiceSceneEnabled,
              onChanged: (value) {
                _update(ref, settings.copyWith(multiVoiceSceneEnabled: value));
              },
            ),
            SwitchListTile(
            ...
            SwitchListTile(
              ...
              onChanged: (value) {
                _update(ref, settings.copyWith(languageRotationEnabled: value));
              },
            ),
            SwitchListTile(
            ...
            FilledButton.tonal(
              onPressed: () async {
                ...
                await service.speakHourlyTime(now, testSettings);
                await service.speakWeather(
                  ref.read(weatherProvider).value,
                  testSettings,
                  now,
                );
              },
